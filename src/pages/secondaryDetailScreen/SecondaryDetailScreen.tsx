      ...
      <Box sx={CommonStyle.authLayoutcard}>
        <Box style={{ backgroundColor: "success.light" }}>
          <Stack sx={{ flexDirection: "row", justifyContent: "space-between" }}>
            ...
            <Typography sx={CommonStyle.backButton} onClick={gobackAction}>Back</Typography>
          </Stack>
        ...
        >
          <Box sx={{ marginBottom: "15px",marginTop:'20px'}}>
            ...
            <Box sx={{ display: "flex", alignItems: "flex-start" }}>
              ...
              >
                I accept the{" "}
                <Link href="https://www.google.co.in/" style={{ color: CommonColor.otpTextBlue, fontSize: "12px",cursor:'pointer'}} >
                  Terms & Conditions
                </Link>{" "}
                and{" "}
                <Link href="https://www.google.co.in/" style={{ color: CommonColor.otpTextBlue, fontSize: "12px",cursor:'pointer' }}>
