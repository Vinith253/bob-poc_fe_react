    ...
    <>
      <Box sx={CommonStyle.authLayoutcard}>
        <Box style={{ backgroundColor: "success.light" }}>
          ...
          <Typography sx={CommonStyle.authLayoutDescriptionText} style={{paddingRight:'13px'}}>
            We have sent OTP to your entered mobile number +91 XXXXXXXX10
          </Typography>
 
          <Box sx={{display:'flex',justifyContent:'space-between'}}>
            <TextField variant="outlined" size="small" sx={CommonStyle.otpInputBox}></TextField>
            <TextField variant="outlined" size="small" sx={CommonStyle.otpInputBox}></TextField>
            <TextField variant="outlined" size="small" sx={CommonStyle.otpInputBox}></TextField>
            <TextField variant="outlined" size="small" sx={CommonStyle.otpInputBox}></TextField>
            <TextField variant="outlined" size="small" sx={CommonStyle.otpInputBox}></TextField>
          ...
          <Typography  sx={CommonStyle.otpTextColorFaded} >Resend OTP</Typography>
          <Typography sx={CommonStyle.otpTextColor} onClick={() => navigate("/")} >Change Mobile number</Typography>
        </Box>
        <Box>
